    ...
    return(
        <SBox>
            <Box className="leftBlock">
                <STypography className="title" variant="h3">ПРОЙДИ <b>БЕСПЛАТНОЕ</b> ТЕСТИРОВАНИЕ</STypography>
            ...
            <Box className="rightBlock">
                <BlueBox>
                    <Typography variant="h6" className="cycle" color={themeMain.palette.common.white}>Детям <br/> 6 - 12 лет</Typography>
                </BlueBox>
            </Box>
        </SBox>
    )
